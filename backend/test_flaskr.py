...
class TriviaTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.new_question = {"question": "Do mermaids exists?", "answer": "Allah knows best", "difficulty": 2, "category": "1"}
    ...
    def test_search_question_without_results(self):
        res = self.client().post("/questions", json={"searchTerm": "french"})
        data = json.loads(res.data)
    ...
    def test_404_if_no_questions_exists_per_category(self):
    ...
    def test_400_if_question_body_does_not_exist(self):
